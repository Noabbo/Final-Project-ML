...
# camFrontIn = cv2.VideoCapture(2, cv2.CAP_DSHOW)
...
while True:
    ...
    #     # enteranceFrame = imutils.rotate(enteranceFrame, 90)
    ...
    #     # cv2.line(enteranceFrame, (0, H // 2), (W, H // 2), (0, 255, 255), 2)
